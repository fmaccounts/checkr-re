...
{id:"x1",phase:"besichtigung",text:"Wurde das Gebäude auf Asbest geprüft — kein Verdacht?",sev:2,cost:[1000,5000],tip:"Vinyl- und PVC-Böden, Eternit-Platten und bestimmte Putze vor 1990 enthalten häufig Asbest. Nie brechen oder schleifen. Vor jeglichen Eingriffen ist eine professionelle Analyse zwingend empfohlen. Die Entsorgung muss durch zertifizierte Fachfirmen erfolgen und ist kostspielig."},
{id:"x2",phase:"besichtigung",text:"Sind die Wasserleitungen frei von Bleirohren?",sev:2,cost:[2000,10000],tip:"Bleirohre sind gesundheitsschädlich. Erkennbar am weichen, grauen Metall. Prüfe sichtbare Leitungen im Keller und unter Spülbecken. Ein kompletter Austausch aller Wasserleitungen ist zwingend nötig und kostspielig."},
{id:"x3",phase:"besichtigung",text:"Ist die Elektroinstallation mit Erdung und FI-Schutzschalter ausgestattet?",sev:2,cost:[3000,15000],tip:"Ohne FI besteht akute Brandgefahr. Eine Kompletterneuerung der Elektroinstallation ist aufwändig und teuer. Prüfe auch ob Leitungsquerschnitte für moderne Geräte ausreichen."},
{id:"x4",phase:"besichtigung",text:"Sind die Holzbalkendecken in gutem Zustand — kein Durchhängen, kein morsches Holz?",sev:2,cost:[5000,30000],tip:"Auf Durchhängen, starkes Knarzen und Bohrmehl (Holzwurm) achten. Morsche Stellen bei Bad/Küche deuten auf Feuchtigkeitsschäden. Sanierung extrem aufwändig."},
{id:"x5",phase:"besichtigung",text:"Ist eine intakte Fassadendämmung vorhanden?",sev:1,cost:[5000,25000],tip:"Altbauten vor 1980 haben oft keine Aussendämmung. WDVS prüfen auf Algenbefall, Risse, Spechtschäden. Ohne Dämmung = hohe Heizkosten."},
{id:"x6",phase:"dokumente",text:"Hast du die Protokolle der Eigentümerversammlung geprüft — keine Sonderumlagen geplant?",sev:2,cost:[5000,40000],tip:"Protokolle der letzten 3–5 Jahre zeigen geplante Sanierungen, Streitigkeiten und Sonderumlagen. VOR dem Kaufentscheid einfordern."},
{id:"x7",phase:"dokumente",text:"Ist der Instandhaltungsrücklage ausreichend geäufnet?",sev:2,cost:[5000,30000],tip:"Die jährliche Einlage pro Quadratmeter muss ausreichend sein — als Richtwert gelten 20–40 Euro bzw. 30–50 Franken pro m² und Jahr. Liegt sie deutlich darunter, drohen erhebliche Sonderumlagen. Kontoauszug der Rücklage anfordern."},
{id:"x8",phase:"dokumente",text:"Hast du das Teilungserklärung vollständig gelesen?",sev:1,cost:[0,0],tip:"Regelt Haustiere, Musikinstrumente, Umbauten, Balkongestaltung. Komplett durchlesen vor dem Kauf."},
]},
...
{id:"x10",phase:"besichtigung",text:"Hast du die Garantie-Restlaufzeit und die Mängelliste geprüft?",sev:2,cost:[0,0],tip:"Prüfe die gesetzliche Gewährleistungsfrist und vertragliche Garantien. Mängelliste einfordern und prüfen ob alles behoben wurde."},
{id:"x11",phase:"besichtigung",text:"Ist die Lüftungsanlage in gutem Zustand und regelmässig gewartet?",sev:1,cost:[300,1500],tip:"Minergie braucht regelmässige Filterwechsel. Verschmutzte Filter begünstigen Schimmel. Die jährlichen Wartungskosten sind überschaubar aber zwingend."},
...
{id:"x13",phase:"besichtigung",text:"Sind die Fliesen fest verlegt — keine Hohlstellen beim Klopftest?",sev:1,cost:[1000,5000],tip:"Hohlklingende Fliesen = nicht vollflächig verklebt. Bruchgefahr. Die Nachrüstung ist aufwändig und teuer."},
...
{id:"x15",phase:"dokumente",text:"Ist die Tiefgarage in gutem Zustand — keine Risse, Entwässerung funktioniert?",sev:1,cost:[5000,30000],tip:"Tiefgaragen-Sanierung extrem teuer. Beschichtung, Rinnen und Feuchtigkeitsflecken prüfen."},
...
{id:"x17",phase:"dokumente",text:"Funktionieren alle Fenster und Türen einwandfrei?",sev:0,cost:[0,0],tip:"Bei Neubauten häufig falsch eingestellt. Meist kleiner Justierungsaufwand."},
]},
{id:"efh",label:"Einfamilienhaus",sub:"Alle Baujahre",desc:"Von Dach bis Keller, Garten bis Garage — das volle Programm.",extra:[
{id:"x20",phase:"besichtigung",text:"Ist das Dach in gutem Zustand — keine verrutschten Ziegel, kein Moosbefall?",sev:2,cost:[10000,40000],tip:"Lebensdauer 40–60 Jahre. Moosbefall = hohe Feuchtigkeit. Eine Dachsanierung gehört zu den teuersten Massnahmen."},
{id:"x21",phase:"besichtigung",text:"Ist der Dachstuhl von innen trocken und frei von Schädlingsbefall?",sev:2,cost:[5000,20000],tip:"Im Dachboden auf dunkle Flecken, modrigen Geruch und Bohrmehl achten."},
{id:"x22",phase:"besichtigung",text:"Ist der Keller trocken, rissfrei und die Drainage intakt?",sev:2,cost:[5000,25000],tip:"Alle Kellerräume prüfen: Geruch, Wasserränder, Salzausblühungen. Die nachträgliche Abdichtung von aussen ist aufwändig und teuer."},
{id:"x23",phase:"besichtigung",text:"Ist die Fassade rissfrei und der Sockel trocken?",sev:1,cost:[3000,20000],tip:"Risse >2mm = Setzungsschäden. Abblätternder Putz unten = fehlende Horizontalsperre."},
...
{id:"x26",phase:"dokumente",text:"Hast du die Naturgefahrenkarte geprüft — kein Risikogebiet?",sev:2,cost:[0,0],tip:"Bei der zuständigen Behörde öffentlich einsehbar. Gefährdung = teurere Versicherung oder unversicherbar."},
...
{id:"x31",phase:"besichtigung",text:"Sind die Übergänge und Dehnfugen zum Nachbarhaus rissfrei?",sev:1,cost:[1000,5000],tip:"Unterschiedliche Setzungen verursachen Risse. Dehnfugen innen und aussen prüfen."},
...
{id:"x35",phase:"dokumente",text:"Hast du die Gemeinschaftsordnung vollständig gelesen?",sev:2,cost:[0,0],tip:"Haustiere, Grillverbote, Fassadenfarbe — alles geregelt und bindend. VOR Kauf lesen."},
...
{id:"x41",phase:"besichtigung",text:"Sind die Allgemeinbereiche in gutem Zustand?",sev:1,cost:[5000,25000],tip:"Zeigt Unterhaltszustand. Abgenutzte Bereiche = Investitionsrückstau."},
{id:"x42",phase:"besichtigung",text:"Sind Flachdach, Fassade und Tiefgarage in gutem Zustand?",sev:2,cost:[20000,100000],tip:"Die drei grössten CAPEX-Posten. Jeder dieser Posten kann sechsstellige Kosten verursachen."},
{id:"x43",phase:"besichtigung",text:"Sind Heizung und Elektrik in zeitgemässem Zustand?",sev:2,cost:[10000,40000],tip:"Ölheizungen haben begrenzte Restlaufzeit. Energiekosten/Jahr erfragen."},
...
{id:"k3",text:"Sind alle Unterlagen vorab verfügbar?",sev:1,tip:"Grundriss, Grundbuchauszug, Energieausweis, Nebenkostenabrechnung, Protokolle der Eigentümerversammlung vorab anfordern."},
{id:"k4",text:"Ist die Maklerprovision transparent geregelt?",sev:1,tip:"Wer zahlt die Maklerprovision? Je nach Land und Vereinbarung unterschiedlich geregelt. Vorab klären."},
...
{id:"b1",text:"Ist die Fassade in gutem Zustand — ohne Risse, Putzschäden oder Feuchtigkeit?",sev:2,cost:[2000,15000],tip:"Risse über 2mm können auf Setzungsschäden hinweisen. Verfärbungen und abblätternder Putz im Sockelbereich deuten auf aufsteigende Feuchtigkeit hin. Lasse grössere Risse von einem Fachmann beurteilen."},
{id:"b2",text:"Ist der Keller trocken und geruchsfrei?",sev:2,cost:[5000,25000],tip:"Der Keller ist die ehrlichste Zone im Haus. Achte auf muffigen Geruch (auch wenn gelüftet wurde), Salzausblühungen an den Wänden und feuchte Ecken. Feuchtigkeit im Keller kann auf fehlende Drainage oder eindringendes Grundwasser hindeuten. Die Sanierung ist aufwändig und teuer."},
{id:"b3",text:"Sind die Fenster in gutem Zustand — Doppel-/Dreifachverglasung, dichte Rahmen?",sev:1,cost:[2000,8000],tip:"Kondenswasser zwischen den Scheiben bedeutet defekte Isolierverglasung — die Fenster müssen komplett ersetzt werden. Prüfe auch die Dichtungen und das Alter. Fenster über 25 Jahre stehen meist bald zum Austausch an."},
{id:"b4",text:"Ist die Heizung jünger als 20 Jahre und regelmässig gewartet?",sev:1,cost:[10000,35000],tip:"Heizungen über 20 Jahre stehen kurz vor dem Ersatz. Frage nach dem letzten Service-Datum und den jährlichen Energiekosten. In vielen Regionen gelten bereits Austauschpflichten für fossile Heizungen."},
{id:"b5",text:"Sind Wände und Decken frei von Wasserflecken, Rissen und Durchhängen?",sev:2,cost:[1000,10000],tip:"Wasserflecken an der Decke deuten auf ein undichtes Dach oder einen Leitungsschaden hin. Durchhängende Decken bei Holzbalken sind ein Alarmzeichen für Fäulnis oder Überlastung. Risse können kosmetisch oder strukturell sein — im Zweifelsfall Fachmann beiziehen."},
{id:"b6",text:"Sind Bad und Küche in gutem Zustand — saubere Fugen, kein Schimmel?",sev:1,cost:[2000,10000],tip:"Schwarze Fugen in Dusche und Bad bedeuten Schimmelbefall. Teste auch den Wasserdruck und die Warmwasser-Aufbereitung. Sichtbarer Schimmel ist oft nur die Oberfläche eines tieferliegenden Feuchtigkeitsproblems."},
{id:"b7",text:"Ist die Elektroinstallation zeitgemäss — mit FI-Schutzschalter?",sev:1,cost:[3000,15000],tip:"Öffne den Sicherungskasten: Ist ein FI-Schutzschalter vorhanden? Sind die Sicherungen beschriftet? Prüfe auch ob der Leitungsquerschnitt für moderne Geräte wie Induktionsherd oder E-Auto-Laden ausreicht."},
...
{id:"b9",text:"Funktionieren Türen, Böden und Treppen einwandfrei?",sev:0,cost:[500,5000],tip:"Klemmende Türen können auf Setzungen im Gebäude hindeuten. Prüfe Böden auf Unebenheiten und lose Stellen. Bei Treppen auf Stabilität und fehlende Handläufe achten."},
]},
...
{id:"d2",text:"Ist ein aktueller Energieausweis vorhanden?",sev:1,tip:"Der Energieausweis zeigt die Energieeffizienz des Gebäudes. A/B = gut, D+ = Sanierungsbedarf."},
...
{id:"v3",text:"Ist die Gewährleistung im Vertrag klar geregelt?",sev:2,tip:"«Wie gesehen» = keine Gewährleistung. Bei Neubau: 5 Jahre gesetzliche Gewährleistung (bei Neubau)."},
