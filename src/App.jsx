...
{id:"x7",phase:"dokumente",text:"Ist der Instandhaltungsrücklage ausreichend geäufnet?",sev:2,tip:"Die jährliche Einlage pro Quadratmeter muss ausreichend sein — als Richtwert gelten 20–40 Euro bzw. 30–50 Franken pro m² und Jahr. Liegt sie deutlich darunter, drohen erhebliche Sonderumlagen. Kontoauszug der Rücklage anfordern."},
{id:"x8",phase:"dokumente",text:"Hast du das Teilungserklärung vollständig gelesen?",sev:1,tip:"Regelt Haustiere, Musikinstrumente, Umbauten, Balkongestaltung. Komplett durchlesen vor dem Kauf."},
]},
...
{id:"x10",phase:"besichtigung",text:"Hast du die Garantie-Restlaufzeit und die Mängelliste geprüft?",sev:2,tip:"Prüfe die gesetzliche Gewährleistungsfrist und vertragliche Garantien. Mängelliste einfordern und prüfen ob alles behoben wurde."},
{id:"x11",phase:"besichtigung",text:"Ist die Lüftungsanlage in gutem Zustand und regelmässig gewartet?",sev:1,tip:"Minergie braucht regelmässige Filterwechsel. Verschmutzte Filter begünstigen Schimmel. Die jährlichen Wartungskosten sind überschaubar aber zwingend."},
{id:"x12",phase:"besichtigung",text:"Ist der Schallschutz ausreichend — kein störender Trittschall oder Technik-Lärm?",sev:1,tip:"Teste wenn Nachbarn da sind. Schlechter Schallschutz ist nachträglich kaum behebbar."},
{id:"x13",phase:"besichtigung",text:"Sind die Fliesen fest verlegt — keine Hohlstellen beim Klopftest?",sev:1,tip:"Hohlklingende Fliesen = nicht vollflächig verklebt. Bruchgefahr. Die Nachrüstung ist aufwändig und teuer."},
{id:"x14",phase:"besichtigung",text:"Ist die Wärmepumpe leise und effizient?",sev:1,tip:"Luft-WP bei tiefen Temperaturen laut. Position relativ zu Schlafräumen prüfen. COP über 3.5."},
{id:"x15",phase:"dokumente",text:"Ist die Tiefgarage in gutem Zustand — keine Risse, Entwässerung funktioniert?",sev:1,tip:"Tiefgaragen-Sanierung extrem teuer. Beschichtung, Rinnen und Feuchtigkeitsflecken prüfen."},
{id:"x16",phase:"dokumente",text:"Stimmen die budgetierten Betriebskosten mit der Abrechnung überein?",sev:1,tip:"Erste Abrechnungen bei Neubauten oft höher als erwartet. Budgetannahmen mit realen Zahlen vergleichen."},
{id:"x17",phase:"dokumente",text:"Funktionieren alle Fenster und Türen einwandfrei?",sev:0,tip:"Bei Neubauten häufig falsch eingestellt. Meist kleiner Justierungsaufwand."},
]},
...
{id:"x31",phase:"besichtigung",text:"Sind die Übergänge und Dehnfugen zum Nachbarhaus rissfrei?",sev:1,tip:"Unterschiedliche Setzungen verursachen Risse. Dehnfugen innen und aussen prüfen."},
{id:"x32",phase:"besichtigung",text:"Ist der Keller ausreichend belüftet und trocken?",sev:1,tip:"Eingeschränkte Belüftung im Keller — Feuchtigkeit und Schimmel häufig."},
{id:"x33",phase:"besichtigung",text:"Ist die Verantwortung für Dach und Fassade klar geregelt?",sev:1,tip:"Wer zahlt bei Sanierung? Zustimmung des Nachbarn nötig? Reglement prüfen."},
{id:"x34",phase:"besichtigung",text:"Gehört der Parkplatz klar zum Eigentum?",sev:1,tip:"Zufahrt über Nachbars Grundstück? Grundbuchauszug auf Wegrechte prüfen."},
{id:"x35",phase:"dokumente",text:"Hast du die Gemeinschaftsordnung vollständig gelesen?",sev:2,tip:"Haustiere, Grillverbote, Fassadenfarbe — alles geregelt und bindend. VOR Kauf lesen."},
{id:"x36",phase:"dokumente",text:"Ist die Kostenverteilung der Gemeinschafts-Heizung klar geregelt?",sev:1,tip:"Wer entscheidet über Ersatz? Kostenverteilung nach Fläche oder Verbrauch?"},
{id:"x37",phase:"dokumente",text:"Sind die Grundstücksgrenzen aktuell vermessen und klar definiert?",sev:1,tip:"Bei Reihenhäusern häufig Streit über Grenzen. Grundbuchplan prüfen."},
]},
{id:"mfh",label:"Mehrfamilienhaus",sub:"Renditeobjekt",desc:"Mieterträge, Zustand und CAPEX-Planung prüfen.",extra:[
{id:"x40",phase:"inserat",text:"Basiert die angegebene Rendite auf tatsächlichen Ist-Mieten?",sev:2,tip:"Inserierte Rendite basiert oft auf Soll-Miete. Rechne selbst mit Ist-Mieten und 3–5% Leerstand."},
{id:"x41",phase:"besichtigung",text:"Sind die Allgemeinbereiche in gutem Zustand?",sev:1,tip:"Zeigt Unterhaltszustand. Abgenutzte Bereiche = Investitionsrückstau."},
{id:"x42",phase:"besichtigung",text:"Sind Flachdach, Fassade und Tiefgarage in gutem Zustand?",sev:2,tip:"Die drei grössten CAPEX-Posten. Jeder dieser Posten kann sechsstellige Kosten verursachen."},
{id:"x43",phase:"besichtigung",text:"Sind Heizung und Elektrik in zeitgemässem Zustand?",sev:2,tip:"Ölheizungen haben begrenzte Restlaufzeit. Energiekosten/Jahr erfragen."},
...
{id:"b4",text:"Ist die Heizung jünger als 20 Jahre und regelmässig gewartet?",sev:1,tip:"Heizungen über 20 Jahre stehen kurz vor dem Ersatz. Frage nach dem letzten Service-Datum und den jährlichen Energiekosten. In vielen Regionen gelten bereits Austauschpflichten für fossile Heizungen."},
{id:"b5",text:"Sind Wände und Decken frei von Wasserflecken, Rissen und Durchhängen?",sev:2,tip:"Wasserflecken an der Decke deuten auf ein undichtes Dach oder einen Leitungsschaden hin. Durchhängende Decken bei Holzbalken sind ein Alarmzeichen für Fäulnis oder Überlastung. Risse können kosmetisch oder strukturell sein — im Zweifelsfall Fachmann beiziehen."},
      ...
      {scr==="saved"&&!vid&&(<div style={{padding:16,...bx}}>
        ...
        {saved.map(s=>(
          <div key={s.id} onClick={()=>setVid(s.id)} style={{background:C.s1,border:`1px solid ${C.ln}`,borderRadius:10,padding:12,marginBottom:8,cursor:"pointer"}}>
            ...
            <div style={{display:"flex",gap:10,fontSize:11}}><span style={{color:C.ok}}>✓ {s.yes}</span><span style={{color:C.err}}>✗ {s.no}</span></div>
      ...
      {scr==="saved"&&vid&&(()=>{const s=saved.find(x=>x.id===vid);if(!s)return null;return(
        <div style={{...bx}}>
          ...
          {s.details?.length>0&&<div style={{padding:"12px 16px"}}><h3 style={{fontFamily:F.b,fontSize:13,fontWeight:700,marginBottom:8}}>Probleme ({s.details.length})</h3>
            {s.details.map((d,i)=><div key={i} style={{background:C.s1,borderRadius:8,padding:"10px 12px",marginBottom:6,borderLeft:`3px solid ${d.sev===2?C.err:C.wrn}`}}><div style={{fontFamily:F.m,fontSize:8.5,color:C.ink3,marginBottom:2}}>{d.phase}</div><div style={{fontSize:12,lineHeight:1.4}}>{d.text}</div><div style={{fontSize:10.5,color:C.ink2,marginTop:3,lineHeight:1.45}}>{d.tip}</div></div>)}
          </div>}
